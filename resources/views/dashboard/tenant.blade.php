...
.modal-apple .modal-title {
  font-weight: 800;
  letter-spacing: -0.02em;
}

.modal-apple .btn-close {
  opacity: .6;
}
.modal-apple .btn-close:hover {
  opacity: 1;
}
...
.af-input:focus,
.modal-apple input:focus,
.modal-apple select:focus {
  outline: none;
  border-color: #0071e3;
...
<input type="hidden" name="lease_agreement_id" value="{{ $latestSignedLease->id }}">
