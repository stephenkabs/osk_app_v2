...
@php
    ...
    $avatarUrl = $user->profile_image
        ...
        : 'https://ui-avatars.com/api/?name=' . urlencode($userName) . '&color=FFFFFF&background=da890f&size=256';
@endphp

{{-- HEADER --}}
<div class="d-flex align-items-center justify-content-between mb-4 p-4 rounded-4 bg-white shadow-sm border">
    ...
    <div>
        ...
        <p class="text-muted mb-0 small">
            Centralized control for your property, tenants, and finances
        </p>
    </div>
