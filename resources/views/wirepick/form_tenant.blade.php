...
<form method="POST"
      action="{{ route('wp.processRentPayment') }}"
      class="wp-form">
    @csrf
    ...
    {{-- MSISDN --}}
    <div class="form-group" id="msisdnField">
        <label>MSISDN</label>
        <input type="text" name="msisdn" placeholder="097xxxxxxx">
    </div>

    {{-- CARD --}}
    <div id="cardFields" class="card-area">
        <input type="text" name="pan" placeholder="Card Number">
